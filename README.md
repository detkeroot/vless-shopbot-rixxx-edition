...
1. Зарегистрируйтесь в личном кабинете автора на **[lava.top](https://app.lava.top)**.
2. Создайте новый **«Цифровой продукт»** (например, с названием *«VPN Доступ»*). При создании включите опцию **«Цена по запросу через API»** и скопируйте полученный **Offer ID** (UUID оффера).
